...
function NewVolunteerModal({ open, onInputChange, volunteer, handleClose }: { open: boolean; onInputChange: (e: React.ChangeEvent<HTMLInputElement>) => void, volunteer: Volunteer, handleClose: (submit: boolean) => void }) {
